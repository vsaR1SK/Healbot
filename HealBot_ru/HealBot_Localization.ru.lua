...
-- Class
    ...
    HEALBOT_ZONE_IC                         = "ОстроВо ввоеваний"; 
    ...
    HEALBOT_SKIN_CHECK_DONE                 = "Проверка целостности скиноВо ввершена";
    HEALBOT_ALLOW_DUPLICATES                = "Разрешить дубдикаты";
    ...
    HEALBOT_ABOUT_FAQ_ANSWERS = {
        ...
        [13] = "Личный список целей позволяет вам создать список целей, которые\n" ..
               ...
               '- Используйте Меню HealBot (настройка "hbmenut" во вкладке Заклинания)\n' ..
